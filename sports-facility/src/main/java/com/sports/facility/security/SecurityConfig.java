...
//        
        ...
        // .cors().disable()
        .exceptionHandling().authenticationEntryPoint(unauthorizedHandler).and()
         .authorizeHttpRequests().antMatchers("/sports/sign-in").permitAll()
         .antMatchers("/sports/sign-up").permitAll()
         .antMatchers("/sports/bookfacility", "/sports/getcountries").permitAll()
         
         .antMatchers("/v2/api-docs", "/configuration/**", "/swagger*/**", "/webjars/**").permitAll()
         .antMatchers("/sports/test").permitAll()
